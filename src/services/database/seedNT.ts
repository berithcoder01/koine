...
const NT: TokenSeed[] = [
  ...
  // ROMANOS 8:28 (C1 M02)
  // ═══════════════════════════════════════════════════════════════
  {bookAbbr:'ROM',bookName:'Romanos',ch:8,v:28,p:1,token:'Οἴδαμεν',lemma:'οἶδα',sid:'G1492',pars:'V-RAI-1P',gloss:'Sabemos'},
  {bookAbbr:'ROM',bookName:'Romanos',ch:8,v:28,p:2,token:'δὲ',lemma:'δέ',sid:'G1161',pars:'CONJ',gloss:'que'},
  {bookAbbr:'ROM',bookName:'Romanos',ch:8,v:28,p:3,token:'ὅτι',lemma:'ὅτι',sid:'G3754',pars:'CONJ',gloss:'que'},
  {bookAbbr:'ROM',bookName:'Romanos',ch:8,v:28,p:4,token:'τοῖς',lemma:'ὁ',sid:'G3588',pars:'T-DPM',gloss:'aos'},
  {bookAbbr:'ROM',bookName:'Romanos',ch:8,v:28,p:5,token:'ἀγαπῶσι',lemma:'ἀγαπάω',sid:'G25',pars:'V-PAP-DPM',gloss:'que amam'},
  {bookAbbr:'ROM',bookName:'Romanos',ch:8,v:28,p:6,token:'τὸν',lemma:'ὁ',sid:'G3588',pars:'T-ASM',gloss:'a'},
  {bookAbbr:'ROM',bookName:'Romanos',ch:8,v:28,p:7,token:'θεὸν',lemma:'θεός',sid:'G2316',pars:'N-ASM',gloss:'Deus'},

  // ═══════════════════════════════════════════════════════════════
  // 1 CORÍNTIOS 13:1-2 (amor) — C1 M07
  // ═══════════════════════════════════════════════════════════════
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:1,p:1,token:'Ἐὰν',lemma:'ἐάν',sid:'G1437',pars:'CONJ',gloss:'Se'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:1,p:2,token:'ταῖς',lemma:'ὁ',sid:'G3588',pars:'T-DFP',gloss:'as'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:1,p:3,token:'γλώσσαις',lemma:'γλῶσσα',sid:'G1100',pars:'N-DFP',gloss:'línguas'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:1,p:4,token:'τῶν',lemma:'ὁ',sid:'G3588',pars:'T-GMP',gloss:'dos'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:1,p:5,token:'ἀνθρώπων',lemma:'ἄνθρωπος',sid:'G444',pars:'N-GMP',gloss:'homens'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:1,p:6,token:'λαλῶ',lemma:'λαλέω',sid:'G2980',pars:'V-PAS-1S',gloss:'falar'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:1,p:7,token:'ἀγάπην',lemma:'ἀγάπη',sid:'G26',pars:'N-ASF',gloss:'amor'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:1,p:8,token:'δὲ',lemma:'δέ',sid:'G1161',pars:'CONJ',gloss:'mas'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:1,p:9,token:'μὴ',lemma:'μή',sid:'G3361',pars:'ADV',gloss:'não'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:1,p:10,token:'ἔχω,',lemma:'ἔχω',sid:'G2192',pars:'V-PAS-1S',gloss:'tenha'},

  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:2,p:1,token:'νῦνὶ',lemma:'νυνί',sid:'G3570',pars:'ADV',gloss:'agora'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:2,p:2,token:'δὲ',lemma:'δέ',sid:'G1161',pars:'CONJ',gloss:'mas'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:2,p:3,token:'μένει',lemma:'μένω',sid:'G3306',pars:'V-PAI-3S',gloss:'permanece'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:2,p:4,token:'πίστις,',lemma:'πίστις',sid:'G4102',pars:'N-NSF',gloss:'fé'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:2,p:5,token:'ἐλπίς,',lemma:'ἐλπίς',sid:'G1680',pars:'N-NSF',gloss:'esperança'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:2,p:6,token:'ἀγάπη,',lemma:'ἀγάπη',sid:'G26',pars:'N-NSF',gloss:'amor'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:2,p:7,token:'τὰ',lemma:'ὁ',sid:'G3588',pars:'T-NPN',gloss:'estas'},
  {bookAbbr:'1COR',bookName:'1 Coríntios',ch:13,v:2,p:8,token:'τρία·',lemma:'τρεῖς',sid:'G5140',pars:'A-NPN',gloss:'três'},

  // ═══════════════════════════════════════════════════════════════
  // APOCALIPSE 1:8 (C1 M08)
  // ═══════════════════════════════════════════════════════════════
  {bookAbbr:'REV',bookName:'Apocalipse',ch:1,v:8,p:1,token:'Ἐγώ',lemma:'ἐγώ',sid:'G1473',pars:'P-NS',gloss:'Eu'},
  {bookAbbr:'REV',bookName:'Apocalipse',ch:1,v:8,p:2,token:'εἰμι',lemma:'εἰμί',sid:'G1510',pars:'V-PAI-1S',gloss:'sou'},
  {bookAbbr:'REV',bookName:'Apocalipse',ch:1,v:8,p:3,token:'τὸ',lemma:'ὁ',sid:'G3588',pars:'T-NSN',gloss:'o'},
  {bookAbbr:'REV',bookName:'Apocalipse',ch:1,v:8,p:4,token:'Ἄλφα',lemma:'ἄλφα',sid:'G1',pars:'N-NSN',gloss:'Alfa'},
  {bookAbbr:'REV',bookName:'Apocalipse',ch:1,v:8,p:5,token:'καὶ',lemma:'καί',sid:'G2532',pars:'CONJ',gloss:'e'},
  {bookAbbr:'REV',bookName:'Apocalipse',ch:1,v:8,p:6,token:'τὸ',lemma:'ὁ',sid:'G3588',pars:'T-NSN',gloss:'o'},
  {bookAbbr:'REV',bookName:'Apocalipse',ch:1,v:8,p:7,token:'Ὦ',lemma:'ὦ',sid:'G5598',pars:'N-NSN',gloss:'Ômega'},
  {bookAbbr:'REV',bookName:'Apocalipse',ch:1,v:8,p:8,token:'–',lemma:'–',sid:'',pars:'',gloss:''},
];

export const seedNT = async () => {
  const db = databaseService.getDB();

  const existing = await db.query('SELECT COUNT(*) as count FROM nt_text');
  if ((existing.values?.[0]?.count ?? 0) > 20) {
    console.log('[Seed] NT text already seeded, skipping');
    return;
  }

  const statements = NT.map((t) => ({
  ...
  console.log(`[Seed] ${NT.length} NT tokens seeded`);
};
