...
const MODE_CONFIG: Record<ReaderMode, ModeConfig> = {
  assisted: {
    ...
    shortLabel: 'Guia',
    icon: '📖',
    description: 'Grego com gloss + Tradução em português sempre visível',
  },
  challenge: {
    label: 'Desafio',
    shortLabel: 'Foco',
    icon: '🎯',
    description: 'Grego sem ajuda + Teste de tradução sob demanda',
  },
  immersion: {
    label: 'Imersão',
    shortLabel: 'Grego',
    icon: '🌊',
    description: 'Apenas texto grego (sem tradução ou ajuda em português)',
  },
  interlinear: {
    label: 'Interlinear',
    shortLabel: 'Linear',
    icon: '🔤',
    description: 'Linha de grego corrido + Linha de português corrido',
  },
  transliteration: {
