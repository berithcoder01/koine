    ...
    {module && (
      <div className="flex flex-col gap-4">
        <div className="bg-background rounded-xl p-4">
          <p className="text-xs text-textSecondary mb-2 uppercase tracking-wide font-medium">
            Versículo Âncora
          </p>
          <GreekText text={module.anchor_verse} size="md" />
          <p className="text-textSecondary text-xs mt-2">{module.anchor_reference}</p>
        </div>

        <div className="bg-background rounded-xl p-4">
          <p className="text-xs text-textSecondary mb-1 uppercase tracking-wide font-medium">
            Método
          </p>
          <p className="text-textPrimary text-sm">{module.method_primary}</p>
        </div>
        ...
        <div className="flex gap-3">
          <div className="flex-1 bg-secondary/10 rounded-xl p-3 text-center">
            ...
            <p className="text-textSecondary text-xs">XP total</p>
          </div>
          <div className="flex-1 bg-primary/10 rounded-xl p-3 text-center">
            ...
            <p className="text-textSecondary text-xs">Exercícios</p>
          </div>
        </div>
